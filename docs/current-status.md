...
最后更新：2026-07-10（E.7-B 向量 RAG embedding + hybrid 检索）
...
**当前开发重点：** E.7 轻量 RAG 两阶段已交付。可选后续：**巩固 E.7 读码**、**eval 加固**（安全 case 稳定性）、**E.3.5-f 代码高亮**、或按 [`docs/learning-plan.md`](learning-plan.md) 进入新主题。
