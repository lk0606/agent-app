...
最后更新：2026-06-09（前端 Step 2 session 列表 + Step 4 调试面板）
...
**Step 2 已完成：** 左栏 session 列表、点击恢复历史、summary preview、归档（见 [Step 2](#step-2会话查询前后端)）。

**Step 4 部分完成：** 调试面板已展示 message timeline / session summary / task status / plannerTrace；独立 task 详情页未做。
