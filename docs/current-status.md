...
最后更新：2026-07-07（E.6 扩 eval：18 条用例 + 改坏实验）
...
**当前开发重点：** **E.6 扩 eval** —— 用例与改坏实验见 [`docs/backend-learning/eval-break-lab.md`](backend-learning/eval-break-lab.md)；巩固周手册 [`docs/consolidation-week.md`](consolidation-week.md)。
